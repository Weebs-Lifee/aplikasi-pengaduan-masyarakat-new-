		...
		<div class="row justify-content-center" style="margin-top: 1%">
			<div class="col-md-12">
				<div class="card p-3">
					...
					<form method="post" action="aksi_edit_pengguna.php">
						<?php
							include 'koneksi.php';
						...
						<div class="mb-3">
							<label>Nama</label>
							<input type="text" class="form-control" name="nama" required="" value="<?php echo $d['nama']; ?>" placeholder="Masukan nama anda">
							<input type="hidden" name="id" value="<?php echo $d['id']; ?>">
						</div>
						<div class="mb-3">
							<label>Email</label>
							<input type="email" class="form-control" name="email" required="" value="<?php echo $d['email']; ?>" placeholder="Masukan email anda">
						</div>
						<div class="mb-3">
							<label>Telephone</label>
							<input type="number" class="form-control" name="telp" required="" value="<?php echo $d['telp']; ?>" placeholder="Masukan telephone anda">
						</div>
						<div class="mb-3">
							<label>Alamat</label>
							<textarea class="form-control" rows="3" name="alamat" required="" placeholder="Masukan alamat anda"><?php echo $d['alamat']; ?></textarea>
						</div>
						<div class="mb-3">
							<label>Status</label>
							<select class="form-control" name="role">
								...
								<option value="petugas" <?php echo $d['role'] === 'petugas' ? 'selected' : ''; ?>>Petugas</option>
